...
bootstrapRuntime.createElementRegistry = bootstrapRuntime.createElementRegistry || function createElementRegistry(document) {
  return {
    ...
    mostMissedCard: document.querySelector("#mostMissedCard"),
    mostMissedToggle: document.querySelector("#mostMissedToggle"),
    reviewAnalyticsCard: document.querySelector("#reviewAnalyticsCard"),
    reviewAnalyticsToggle: document.querySelector("#reviewAnalyticsToggle"),
